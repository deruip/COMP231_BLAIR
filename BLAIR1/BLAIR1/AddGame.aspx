<%@ Page Title="Register New Game" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="AddGame.aspx.cs" Inherits="AddGame" %>
<asp:Content ID="page_FirstParagraph" ContentPlaceHolderID="MainContent" runat="server" Text="Please enter the game information: " />
    <div class="col-sm-6">
